loot spawn ~.5 ~.5 ~.5 loot esb:block/live_spruce_log
execute positioned ~.5 ~.5 ~.5 run item modify entity @n[type=item,nbt={Item:{id:"minecraft:spruce_log"}},distance=...5] contents esb:count_-1
